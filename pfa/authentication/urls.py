...
from authentication import views, api
...
urlpatterns = [
    ...
    # Les nouveaux endpoints API pour React
    ...
    path('api/password-reset/', api.password_reset_request_api, name='api_password_reset'),
    path('api/password-reset-confirm/', api.password_reset_confirm_api, name='api_password_reset_confirm'),
